...
something in a definition. \cmd*{cmd} will be defined using \paket{etoolbox}'
\cmd{newrobustcmd} which means an error will be thrown if \cmd*{cmd} is already
defined.
...
\begin{beispiel}
 ...
 % \newsubidxcmd{\test}{Test}{\textcolor{red}{#1}}
 % \newsubidxcmd*{\hsnbg}{\name[Heisenberg]{Werner Heisenberg}}{#1}
 \name[Heisenberg]{Werner Heisenberg} was born in \hsnbg[Wuerzburg]{W\"urzburg
